package com.uscode.alioolio.api.google.tts.service;
...
public class TextToSpeechService {
    ...
    private final String voiceName = "ko-KR-Wavenet-A"; // 기본 음성 이름 (한국어 Wavenet 음성)
    private final String ssmlGender = "FEMALE"; // 기본 성별 (중립)
